...
<div class="card mt-2">
    <div class="card-body">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <form method="post" action="tambah_detail_pembelian.php">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="simpan_barang_beli.php" method="post">
                                    <div class="form-group">
                                        <input type="text" name="id_pelanggan" value="<?= $d['id_pelanggan']; ?>" hidden>
                                        <input type="text" name="id_detail" value="<?= $d_detail_penjualan['id_detail']; ?>" hidden>
                            ...
                            <td>
                                ...
                                <form method="post" action="hapus_detail_pembelian.php">
                                    <input type="text" name="id_pelanggan" value="<?= $d['id_pelanggan']; ?>" hidden>
                                    <input type="text" name="id_detail" value="<?= $d_detail_penjualan['id_detail']; ?> "hidden>
                                    <button type="submit" class="btn btn-danger btn-sm mt-">Hapus</button>
                                </form>
                            </td>
                        </tr>
                    <?php } else {
            ...
            <form method="post" action="simpan_total_harga.php">
                <?php
                $detail_penjualan =  mysqli_query($koneksi, "SELECT SUM(subtotal) AS total_harga FROM detail_penjualan WHERE id_penjualan='$d[id_penjualan]'");
